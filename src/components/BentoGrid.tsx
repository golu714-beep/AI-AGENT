...
const BentoGrid = () => {
  return (
    <section
      id="features"
      className="py-12 md:py-24 max-w-7xl mx-auto px-6 relative"
    >
      ...
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-8 md:mb-16 gap-10">
        <div className="max-w-3xl">
          ...
          >
            REDEFINING THE{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-400 to-primary drop-shadow-[0_0_30px_rgba(139,92,246,0.3)]">
              PARADIGM.
            </span>
          </motion.h2>
        </div>
        ...
        >
          Scalable, secure, and intelligent modules designed for the next era of
          high-frequency enterprise operations.
        </motion.p>
      </div>
            ...
            {[1, 2, 3, 4, 5, 6].map((i) => (
              ...
              >
                <div className="flex flex-col gap-1">
                  <span className="text-[10px] font-mono font-black text-gray-500 tracking-[0.3em] uppercase group-hover/item:text-primary transition-colors">
                    SESS_#{(2048 * i).toString(16).toUpperCase()}
                  </span>
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={cn(
                      ...
                      i === 1
                        ? "bg-primary animate-pulse shadow-[0_0_10px_rgba(139,92,246,0.8)]"
                        : "bg-gray-800",
                    )}
                  />
                </div>
