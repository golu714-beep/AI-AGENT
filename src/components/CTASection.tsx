...
const MinimalCalculator = ({ agentCount, setAgentCount, avgSalary, setAvgSalary, savings }: MinimalCalculatorProps) => {
    return (
        <motion.div 
                ...
                <div className="flex-1 w-full space-y-12">
                    <div className="space-y-6">
                        <div className="flex justify-between items-end mb-2">
                            <span className="text-[10px] font-mono font-black uppercase tracking-[0.3em] text-white/40">Human_Nodes</span>
                            <span className="text-2xl font-display font-black text-white italic">{agentCount}</span>
                        </div>
                        <input 
                    ...
                    <div className="space-y-6">
                        <div className="flex justify-between items-end mb-2">
                            <span className="text-[10px] font-mono font-black uppercase tracking-[0.3em] text-white/40">Overhead_Factor</span>
                            <span className="text-2xl font-display font-black text-white italic">₹{(avgSalary/1000).toFixed(0)}k</span>
                        </div>
                        <input 
...
const CTASection = () => {
    ...
    return (
        <section ref={sectionRef} id="cta" className="relative py-20 md:py-64 overflow-hidden bg-[#020203]">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <span className="text-xs font-black uppercase tracking-[0.4em] text-white/60">Ready to Scale</span>
                </motion.div>
                ...
                >
                    TRANSFORM <span className="text-primary italic font-black">OPERATIONS.</span>
                </motion.h2>
