      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-16 mb-24">
          ...
          <div className="lg:col-span-4 max-w-sm">
            <Link href="/" className="flex items-center gap-4 mb-10 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[7px] font-mono text-gray-600 uppercase tracking-widest font-bold">Protocol_v4.2</span>
              </div>
            </Link>
            <p className="text-gray-500 text-sm leading-relaxed mb-10 border-l border-primary/20 pl-6 border-dashed">
              Revolutionizing enterprise customer experience through predictive intelligence and autonomous voice node clusters.
            </p>
            <div className="flex gap-4">
              {[Twitter, Github, Linkedin, Mail].map((Icon, i) => (
                <Link key={i} href="#" className="w-10 h-10 rounded-xl bg-white/[0.02] border border-white/[0.05] text-gray-500 hover:text-primary hover:border-primary/30 transition-all flex items-center justify-center group/icon hover:scale-110 active:scale-95 shadow-inner">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-[9px] font-mono font-black uppercase tracking-[0.4em] text-white/40 mb-10">OS_LAYER_01</h4>
            <ul className="space-y-4">
              {["Platform", "Solutions", "Voice Engine", "Security", "Ecosystem"].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-[11px] font-black uppercase tracking-widest text-gray-600 hover:text-white transition-all flex items-center gap-2 group/link">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-[9px] font-mono font-black uppercase tracking-[0.4em] text-white/40 mb-10">OS_LAYER_02</h4>
            <ul className="space-y-4">
              {["About", "Customers", "Enterprise", "Contact", "Careers"].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-[11px] font-black uppercase tracking-widest text-gray-500 hover:text-white transition-all flex items-center gap-2 group/link">
                     <div className="w-1 h-1 rounded-full bg-primary/20 group-hover/link:bg-primary transition-colors" />
                    {item}
                  </Link>
                </li>
          ...
          <div className="lg:col-span-4">
            <h4 className="text-[9px] font-mono font-black uppercase tracking-[0.4em] text-white/40 mb-10">STATUS_FEED</h4>
            <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6 md:p-8 relative overflow-hidden group/news">
              <div className="relative z-10">
                <h5 className="text-white text-lg font-bold mb-3">Sync with Aitelz.</h5>
                <p className="text-gray-500 text-xs mb-8 font-medium">Join the elite network of enterprise innovators.</p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-white/5 gap-6 md:gap-8">
          <div className="flex flex-col items-center md:items-start gap-1">
             ...
             <span className="text-[7px] font-mono text-gray-800 uppercase tracking-widest">All_Rights_Verified_SLA</span>
          </div>
          <div className="flex flex-wrap justify-center md:justify-end gap-x-10 gap-y-4">
            {["Privacy", "Terms", "Compliance", "Architecture"].map((item) => (
                <Link key={item} href="#" className="text-[9px] font-mono font-black text-gray-600 hover:text-primary uppercase tracking-[0.3em] transition-colors">{item}</Link>
            ))}
          </div>
        </div>
      </div>
