...
import { TrendingUp, CreditCard, Mic2, Brain, BarChart3, ShieldCheck, Activity, Globe } from "lucide-react";
...
const solutions = [
  {
    ...
    description: "Reduce operational costs by up to 70% with autonomous AI workers.",
    ...
    preview: (
        <div className="flex flex-col gap-3 p-6 h-full justify-center">
            ...
            <div className="h-1 w-full bg-white/5 rounded-full overflow-hidden">
                <motion.div initial={{ width: "100%" }} whileInView={{ width: "100%" }} className="h-full bg-red-500/20" />
            </div>
            ...
            <div className="h-1 w-full bg-white/5 rounded-full overflow-hidden">
                <motion.div initial={{ width: 0 }} whileInView={{ width: "30%" }} transition={{ duration: 1.5 }} className="h-full bg-primary" />
            </div>
            <div className="mt-4 p-3 border border-primary/20 bg-primary/5 rounded-xl flex items-center justify-between">
                <span className="text-[10px] font-black text-primary uppercase italic">Net Savings</span>
  ...
  },
  {
    ...
    category: "SaaS_Ready",
    title: "Easy Billing",
    description: "Transparent pricing with flexible plans that scale with your growth.",
        ...
        <div className="p-6 flex flex-col items-center justify-center h-full">
            <div className="w-full max-w-[180px] p-4 rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-md relative overflow-hidden group/card shadow-2xl">
                ...
                <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                    <span className="text-[9px] font-black text-white italic uppercase">Billed_Total</span>
  ...
  },
  {
    ...
    title: "Voice Cloning",
    description: "Create custom AI voices for your brand that sound indistinguishable from humans.",
    icon: <Mic2 className="w-5 h-5" />,
    preview: (
        <div className="p-6 flex flex-col justify-center h-full relative">
            <div className="flex items-center gap-3 mb-4">
                <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                <span className="text-[10px] font-mono text-primary/50 uppercase tracking-widest">Neural_Sync_Active</span>
            </div>
            ...
            <div className="flex items-center justify-between px-3 py-2 border border-white/5 bg-white/[0.02] rounded-lg">
                <span className="text-[9px] font-black text-gray-500 italic uppercase">Cloning Accuracy</span>
                <span className="text-[10px] font-black text-emerald-400">99.98%</span>
            </div>
        </div>
    )
  },
  {
    ...
    description: "Comprehensive reporting and insights to track every interaction in real-time.",
        ...
        <div className="p-6 flex flex-col justify-center h-full">
            ...
            <div className="grid grid-cols-2 gap-2">
                <div className="p-2 border border-white/5 bg-white/[0.01] rounded-lg text-center">
                    <span className="block text-xs text-gray-500 font-mono italic">THROUGHPUT</span>
                    <span className="text-[10px] font-black text-white">12.4k/sec</span>
                </div>
                <div className="p-2 border border-white/5 bg-white/[0.01] rounded-lg text-center">
                    <span className="block text-xs text-gray-500 font-mono italic">LATENCY</span>
...
const BusinessSolutions = () => {
    ...
    return (
        <section id="solutions" className="py-20 md:py-32 max-w-7xl mx-auto px-6 overflow-hidden">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-6">
                <div>
                    ...
                    >
                        ...
                        <span className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40">Scale_Integrations</span>
                    </motion.div>
                    <motion.h2 
                    ...
                    >
                        COMPLETE BUSINESS <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-400 to-primary drop-shadow-[0_0_20px_rgba(139,92,246,0.3)]">SOLUTION.</span>
                    </motion.h2>
                </div>
                <motion.p 
                ...
                >
                    Orchestrate hyper-efficient voice workflows at scale. Eliminate overhead, maximize stability.
                </motion.p>
            </div>
                            ...
                            <div className="px-6 pb-6 mt-auto">
                                <div className="h-48 w-full border border-white/[0.04] bg-white/[0.01] rounded-xl relative overflow-hidden group-hover:bg-white/[0.02] transition-colors duration-500">
                                    ...
                                    <div className="absolute top-4 left-4 z-10 scale-90 origin-top-left flex items-center gap-2 px-2.5 py-1 rounded-md bg-white/5 border border-white/10 backdrop-blur-md">
                                        ...
                                        <span className="text-[8px] font-black text-white/40 uppercase tracking-widest">VISUAL_SYNC</span>
                                    </div>
