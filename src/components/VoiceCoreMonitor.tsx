      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12">
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="font-black text-[11px] md:text-[13px] tracking-tight text-white uppercase italic">
                Voice_Core_Alpha
              </div>
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="tracking-[0.2em] uppercase text-[10px] md:text-xs text-gray-600 font-black">
              Live Clusters
            </div>
            {[1, 2, 3].map((i) => (
              <motion.div
        ...
        <div className="md:col-span-2 flex flex-col justify-between pt-2">
          ...
          <div className="mt-8 md:mt-10 flex flex-wrap justify-between items-center gap-6 border-t border-white/[0.06] pt-6 md:pt-8">
            <div className="min-w-[100px]">
              <div className="text-[9px] uppercase font-black text-gray-600 tracking-[0.2em] mb-1">
                Network Latency
              </div>
            ...
            <div className="text-left md:text-right min-w-[100px]">
              ...
              <div className="text-lg md:text-xl font-bold text-primary tracking-tighter">
                99.98%
              </div>
            </div>
          </div>
