        ...
        <div className="flex justify-center pointer-events-auto">
          ...
          >
            ...
            >
              ...
              <Link
                href="/"
                className="flex items-center gap-4 group/logo relative"
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[6px] font-mono text-gray-500 hidden md:block uppercase tracking-widest">
                    Core_Intell_V2
                  </span>
                </div>
              </Link>
                    ...
                    <div className="flex flex-col gap-6">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col gap-1.5 p-4 rounded-xl bg-white/[0.02] border border-white/5">
                          <span className="text-[7px] font-mono text-gray-500 uppercase tracking-widest font-black">
                            Stability
                          </span>
                      ...
                      <div className="flex items-center justify-between gap-4 px-2">
                        <div className="flex items-center gap-4">
                          <div className="flex flex-col">
                            <span className="text-[5px] font-mono text-gray-600 uppercase tracking-widest">
                              Buffer_Sync
                            </span>
