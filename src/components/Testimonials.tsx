...
const testimonials = [
  {
    ...
    content:
      "Bento-Glow AI has completely overhauled how we handle customer surges. The predictive engine is like having a crystal ball for support tickets.",
    avatar: "AR",
  },
  {
    name: "Sarah Chen",
    role: "CEO, Stellar",
    content:
      "The bento design is not just beautiful, it's functional. Our team adapted in hours, and our response times dropped by 45%.",
    avatar: "SC",
  },
  {
    name: "Marcus Thorne",
    ...
    content:
      "Omnichannel that actually works. Integrating WhatsApp and Email in one stream was a game changer for our global team.",
    avatar: "MT",
  },
];
    ...
    <section className="py-20 md:py-32 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 md:mb-32 gap-10">
          ...
          >
            Real-time performance metrics from our distributed enterprise node
            clusters.
          </motion.p>
        </div>
              ...
              <div className="relative h-full bg-[#080809] p-6 md:p-8 flex flex-col gap-8 transition-colors duration-700 group-hover:bg-[#0A0A0B] overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-white/5 pb-6">
                  <div className="flex flex-col gap-1">
                    <span className="text-[7px] font-mono text-primary font-black tracking-widest uppercase">
                      LOG_ENTRY_{i + 1024}
                    </span>
                    <span className="text-[6px] font-mono text-gray-500 font-bold uppercase">
                      TIMESTAMP::2024.Q4
                    </span>
                  </div>
                  <div className="flex gap-1">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star
                        key={s}
                        className="w-2.5 h-2.5 text-primary fill-primary/20 shadow-[0_0_8px_rgba(139,92,246,0.3)]"
                      />
                    ))}
                  </div>
                </div>
                ...
                <div className="mt-auto flex items-center gap-5 pt-8 border-t border-white/5 relative">
                  <div className="relative group/avatar">
                    ...
                    <div className="w-14 h-14 rounded-none bg-black border border-white/10 flex items-center justify-center font-black text-white shadow-2xl relative overflow-hidden group-hover/avatar:border-primary transition-colors">
                      <span className="relative z-10 text-xs tracking-tighter opacity-80">
                        {t.avatar}
                      </span>
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <span className="font-black text-white text-[11px] tracking-tight uppercase">
                        {t.name}
                      </span>
                    </div>
                    <span className="text-[9px] font-mono text-gray-500 tracking-widest uppercase font-bold">
                      {t.role}
                    </span>
                  </div>
