    ...
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden group/globe">
      ...
      <div className="relative w-64 h-64 md:w-96 md:h-96">
        ...
        <div className="absolute inset-4 rounded-full border border-white/10 bg-[#050505] shadow-[inset_0_0_50px_rgba(139,92,246,0.1)] overflow-hidden">
          ...
          >
             <svg width="100%" height="100%" viewBox="0 0 1600 800" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
               {/* Simplified World Path for continuous scroll */}
               <path d="M100 200 L150 250 L200 200 L250 280 L300 150 L350 220 L400 180 L450 300 L500 250 L600 350 L700 200 L800 400 L900 300 L1000 450 L1100 250 L1200 350 L1300 200 L1400 400 L1500 150 L1600 300" stroke="currentColor" strokeWidth="1" />
               <path d="M50 400 L120 450 L250 500 L350 480 L450 550 L550 450 L650 600 L750 500 L850 650 L950 550 L1050 700 L1150 600 L1250 750 L1350 650 L1450 800 L1550 700" stroke="currentColor" strokeWidth="1" />
        ...
        <div className="absolute inset-0 pointer-events-none">
           ...
           >
              <div className="px-3 py-1 bg-white/5 border border-white/10 backdrop-blur-md rounded-md flex items-center gap-2 -rotate-[360deg] animate-pulse">
                ...
                <span className="text-[8px] md:text-[10px] font-mono font-black text-gray-500 uppercase tracking-widest">Global_Sync: OK</span>
              </div>
           </motion.div>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 right-4 md:bottom-8 md:right-8 flex flex-col items-end gap-1 font-mono">
        <span className="text-[8px] uppercase tracking-[0.3em] font-black text-gray-500">Latency_Matrix</span>
