        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-6 md:p-12 rounded-2xl md:rounded-[2.5rem] border border-white/5 bg-white/[0.01] backdrop-blur-3xl overflow-hidden transition-all duration-700 hover:border-primary/20 hover:bg-white/[0.02] relative">
              ...
              <div className="flex justify-between items-start mb-8 md:mb-12">
                ...
                <div className="flex flex-col items-end opacity-20 group-hover:opacity-40 transition-opacity">
                  <span className="text-[8px] font-mono text-white tracking-widest uppercase mb-1">
                    Status::Enabled
                  </span>
              ...
              <div className="relative z-10">
                <span className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-3 block opacity-50">
                  Operational_01
                </span>
                <h3 className="text-2xl md:text-3xl font-black text-white mb-4 md:mb-6 uppercase tracking-tight">
                  Appointment Booking
                </h3>
                <p className="text-gray-500 text-base md:text-lg leading-relaxed font-medium mb-8 md:mb-10">
                  Get instantly integrated with your calendar to book calls in
                  real-time. Full sync with G-Cal, Outlook, and specialized
                  CRMs.
                </p>
          ...
          >
            <div className="p-6 md:p-12 rounded-2xl md:rounded-[2.5rem] border border-white/5 bg-white/[0.01] backdrop-blur-3xl overflow-hidden transition-all duration-700 hover:border-secondary/20 hover:bg-white/[0.02] relative">
              ...
              <div className="relative z-10">
                <span className="text-[10px] font-black text-secondary uppercase tracking-[0.3em] mb-3 block opacity-50">
                  Bridge_Node_02
                </span>
                <h3 className="text-2xl md:text-3xl font-black text-white mb-4 md:mb-6 uppercase tracking-tight">
                  Global Connectivity
                ...
                <p className="text-gray-500 text-base md:text-lg leading-relaxed font-medium mb-8 md:mb-10">
                  Provision numbers from India, USA, UK, and 50+ other
                  countries. Direct fiber-optic termination for zero-latency
                  audio.
                </p>
