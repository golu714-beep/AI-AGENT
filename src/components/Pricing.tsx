...
const plans = [
  {
    ...
    subtext: "one-time",
    description:
      "Perfect for validating AI synergy with your existing workflow.",
  ...
  },
  {
    ...
    buttonColor:
      "bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20 text-white border-primary/20",
    stats: [
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        plan.highlight
          ? "bg-gradient-to-b from-primary/50 to-primary/5 scale-[1.02] z-10 shadow-3xl"
        ...
        <div className="px-3 py-1.5 flex items-center justify-between border-b border-white/10 bg-[#080809] relative group/hheader">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-black font-mono text-white/90 tracking-[0.3em] uppercase leading-none">
                {plan.nodeId}
              </span>
              <span className="text-[7px] font-mono text-primary/40 tracking-[0.2em] font-bold mt-1 uppercase italic leading-none">
                NODE_STATUS: ONLINE
              </span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] font-mono text-gray-500 font-bold uppercase tracking-widest leading-none">
              v4.2
            </span>
          </div>
          {/* Header Laser Sweep */}
        ...
        <div className="px-3 pt-2 pb-1 text-left">
          <div className="flex items-center justify-between mb-3">
            <div className="p-2 rounded-xl bg-white/[0.03] border border-white/10 shadow-inner group-hover:border-primary/30 transition-colors duration-500">
              {React.cloneElement(
                plan.icon as React.ReactElement<{ className?: string }>,
          ...
          <h3 className="text-[12px] font-bold text-gray-400 tracking-widest uppercase mb-1">
            {plan.label}
          </h3>
          ...
          {plan.features ? (
            <div className="space-y-3">
              {plan.features.map((feature, i) => (
                <div key={i} className="flex items-start gap-2.5 group/feat">
                  ...
                  <span className="text-[11px] font-semibold text-gray-500 group-hover/feat:text-white transition-colors">
                    {feature}
                  </span>
                </div>
              ))}
            ...
            <div className="space-y-4">
              {plan.stats?.map((stat, i) => (
                <div
                  key={i}
                  className="flex flex-col gap-0.5 p-3 rounded-xl bg-white/[0.02] border border-white/[0.05] group/stat hover:bg-white/[0.04] transition-all relative overflow-hidden"
                >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-gray-500 text-[13px] font-medium max-w-md mb-8 leading-relaxed opacity-80">
            Highly optimized deployment tiers for enterprise autonomous
            operations. Choose your throughput and scale instantly.
          </p>
          ...
          <div className="p-1.5 md:p-2 bg-black border border-white/10 rounded-none flex items-center gap-2 backdrop-blur-3xl relative group/switcher">
            ...
            <div className="absolute -left-6 top-1/2 -translate-y-1/2 flex flex-col items-center gap-1 opacity-20">
              ...
              <span
                className="text-[5px] font-mono text-primary uppercase rotate-180"
            ...
            >
              ...
              <span
                className={cn(
                  "relative z-20 px-2 py-0.5 rounded-none text-[10px] font-black border transition-colors",
                  isYearly
              ...
              <div className="flex items-center gap-8 relative z-10">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-[13px] font-medium max-w-md leading-relaxed">
                    Dedicated support architects for large-scale production
                    deployments and complex workflow integrations.
                  </p>
                </div>
              </div>
