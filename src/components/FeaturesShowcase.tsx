...
import { Check, ShieldCheck, Zap, MessageSquare, Phone, Mail, ArrowRight, Sparkles, Cpu, Layers, Globe, Activity, Users, Settings, CheckCircle2, MoveUpRight } from "lucide-react";
...
const features = [
    {
        ...
        description: "Complete AI-powered calling solution with advanced voice technology integration for automated customer interactions",
        points: [
    ...
    },
    {
        ...
        description: "Comprehensive customer relationship management with AI-driven insights and automated workflows",
        points: [
    ...
    },
    {
        ...
        description: "Streamline your business processes with intelligent automation and seamless integrations",
        points: [
        ...
        <section className="py-20 md:py-48 bg-[#050505] relative overflow-hidden border-y border-white/[0.02]">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16 md:mb-48">
                    ...
                    >
                        EVERYTHING YOU NEED <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-400 to-primary drop-shadow-[0_0_20px_rgba(139,92,246,0.3)]">FOR AI SUCCESS.</span>
                    </motion.h2>
                    <motion.p 
                    ...
                    >
                        A unified system architected for scale, performance, <br className="hidden md:block" /> 
                                ...
                                >
                                    <div className="flex items-center gap-5">
                                        <div className={cn(
                                            ...
                                            feature.accent === "blue" && "bg-primary/10 border-primary/20 text-primary group-hover:border-primary/50",
                                            feature.accent === "indigo" && "bg-secondary/10 border-secondary/20 text-secondary group-hover:border-secondary/50",
                                            feature.accent === "cyan" && "bg-cyan-500/10 border-cyan-500/20 text-cyan-400 group-hover:border-cyan-500/50"
                                        )}>
                                            {feature.icon}
                                        </div>
                                        ...
                                        {feature.points.map((point, pIdx) => (
                                            <div key={pIdx} className="flex items-start gap-3 group/point">
                                                <div className={cn(
                                                    ...
                                                    feature.accent === "blue" && "group-hover/point:text-primary group-hover/point:border-primary/30",
                                                    feature.accent === "indigo" && "group-hover/point:text-secondary group-hover/point:border-secondary/30",
                                                    feature.accent === "cyan" && "group-hover/point:text-cyan-400 group-hover/point:border-cyan-500/30"
                                                )}>
                                    ...
                                    <div className="relative z-10 rounded-[2rem] overflow-hidden border-[1px] border-white/20 bg-black shadow-[0_80px_160px_rgba(0,0,0,0.95)]">
                                        ...
                                        <div className="px-8 py-5 border-b border-white/10 flex items-center justify-between bg-[#080809] relative overflow-hidden group/header">
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="text-[9px] font-black font-mono text-white/90 tracking-[0.3em] uppercase leading-none">SYS_VIRT_ID_{feature.id}</span>
                                                    <span className="text-[6px] font-mono text-primary/40 tracking-[0.2em] font-bold mt-1 uppercase italic leading-none">STATUS::ACTIVE_SYNC</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="relative aspect-[16/10] bg-[#030304] overflow-hidden group/visual">
                                            ...
                                            <div className="absolute bottom-6 left-6 flex flex-col gap-1 pointer-events-none">
                                                <span className="text-[7px] font-mono text-gray-500 uppercase tracking-widest">Buffer_Load</span>
