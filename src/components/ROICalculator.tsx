    ...
    return (
        ...
        >
            ...
            <div className={cn(
                ...
                isAI ? "border-primary/15 bg-primary/[0.04]" : "border-white/[0.06] bg-white/[0.01]"
            )}>
                <div className="flex items-center gap-4">
                    <div className="flex gap-1.5">
                        <div className={cn("w-2.5 h-2.5 rounded-full transition-all", 
                            isAI ? "bg-primary shadow-[0_0_8px_rgba(139,92,246,0.6)]" : "bg-red-500/40"
                        )} />
                ...
                <div className="flex items-center gap-2">
                    <Activity className={cn("w-3 h-3", isAI ? "text-primary animate-pulse" : "text-gray-700")} />
            ...
            <div className="p-6 md:p-10">
                <div className="flex items-center justify-between mb-8">
                    <div className={cn(
                        ...
                        <Icon className={cn("w-6 h-6", isAI ? "text-primary" : "text-gray-500")} />
                    </div>
                    <span className={cn(
                ...
                <h3 className="text-xl md:text-2xl font-accent font-black text-white mb-2 uppercase italic tracking-tight">{title}</h3>
                ...
                <div className="space-y-3.5">
                    {items.map((item, i) => (
                        ...
                        >
                            <item.icon className={cn("w-4 h-4 shrink-0", isAI ? "text-primary" : "text-red-500/50")} />
    ...
    return (
        <div className="space-y-5">
            <div className="flex justify-between items-end">
                <span className="text-xs font-tactical font-bold text-gray-400 uppercase tracking-[0.15em]">{label}</span>
                <span className="text-2xl md:text-3xl font-display font-black text-white italic tracking-tight">{displayValue}</span>
            </div>
...
const ROICalculator = () => {
    ...
    return (
        <section id="roi-calculator" className="py-20 md:py-32 bg-[#050505] relative overflow-hidden">
            {/* Background effects */}
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-12 md:mb-20">
                    ...
                    >
                        MAXIMIZE YOUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-400 to-primary italic">PROFIT MARGINS.</span>
                    </motion.h2>
                    ...
                    <ComparisonCard
                        ...
                        footer={
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-tactical font-black text-primary/50 uppercase tracking-[0.2em]">Fixed Pricing</span>
                                <span className="text-2xl font-display font-black text-white italic">
                                    ₹19,999<span className="text-xs text-primary/40 not-italic ml-1">/mo</span>
                                </span>
                            </div>
                        }
                    />
                            ...
                            <div className="space-y-10">
                                <div>
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <span className="text-[9px] font-tactical font-black text-primary uppercase tracking-[0.3em]">Interactive</span>
                                    </div>
                                    <h4 className="text-2xl md:text-3xl font-accent font-black text-white mb-3 uppercase italic tracking-tight">Savings Simulator</h4>
                                    <p className="text-gray-500 text-sm leading-relaxed">Adjust the sliders to see your potential annual yield with Aitelz AI.</p>
                                </div>
                                ...
                                <div className="relative z-10 space-y-8">
                                    <div>
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <span className="text-[9px] font-tactical font-black text-primary uppercase tracking-[0.3em]">Estimated Yearly Savings</span>
                                        </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        >
                                            ...
                                            <span className="text-xs font-tactical font-bold uppercase tracking-wider">That&apos;s 1 Month FREE included!</span>
                                        </motion.div>
